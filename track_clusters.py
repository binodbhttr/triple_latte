...
cluster_group="_snapshot_"+str(596) #Remember to change it if you  are changing the star cluster you are tracking in given snapshot
...
for i in range(total_snaps):               #we run a for loop for just two snapshots
